...
export default function ProjectFileExplorerWindowBar() {
    return (
        <div className='h-9 w-full drag flex items-center justify-between pl-2' >
            ...
            <div className='flex items-center gap-2 h-full'>
                <button
                    ...
                    onClick={() => window.ipcRenderer.invoke('export-window:minimize')}
                >
                ...
                <button
                    ...
                    className='h-full w-12 no-drag flex items-center justify-center text-white hover:bg-white/15'
                    onClick={() => window.ipcRenderer.invoke('export-window:toggle-maximize')}
                >
                ...
                <button
                    ...
                    onClick={() => window.ipcRenderer.invoke('export-window:close')}
                >
